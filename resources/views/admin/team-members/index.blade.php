                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <a href="{{ route('team-members.create') }}"><button type="button" class="btn waves-effect btn-secondary"><i class="ion ion-md-add"></i></button></a>
                                </div>
                                <div class="col-12">
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="team_member_{{$value->id}}">
                                                    ...
                                                    <td width="150px">
                                                        <a href="{{ route('team-members.edit', $value->id) }}" class="btn create-icon"><i class="fa fa-fw fa-edit"></i></a>
                                                        ...
                                                        <form id="Deletesubmit_{{ $value->id }}" action="{{ route('team-members.destroy', $value->id) }}" method="POST" class="d-none">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                    </td>
