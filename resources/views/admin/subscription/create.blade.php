                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('admin-subcription.store') }}" id="adminSubscriptionForm"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="allowed_order" name="allowed_order"
                                                        placeholder="Allowed Order" value="{{ old('allowed_order') }}">
    ...
    <script src="https://cdn.ckeditor.com/4.5.11/standard/ckeditor.js"></script>
     <script>
        ...
        $("#adminSubscriptionForm").submit(function(e) {
            ...
            else if($("#plan_name").val().length > 100)
            {
                $("#planNameSpan").html("Plan Name must not be greater than 100 character");
                temp++;
            }
            else{
                $("#planNameSpan").html("");
