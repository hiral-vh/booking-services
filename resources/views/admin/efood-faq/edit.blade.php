                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('efood-faq.index') }}" title="Back"><button type="button"
                                                class="btn waves-effect btn-secondary"><i
                                                    class="ion ion-md-arrow-back"></i></button></a>
                                    </div>
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('efood-faq.update',$faq->id) }}" id="faqEditForm"
                                            ...
                                            <div class="form-group row">
                                                <label for="question" class="col-sm-1 control-label space-for-label">Question<span
                                                    ...
                                                    <div class="col-sm-10">
                                                    <textarea class="form-control" id="question" name="question" rows="3" placeholder="Question">{{$faq->faq_question}}</textarea>
                                                    <span class="error" id="questionSpan">{{$errors->admin->first('question')}}</span>
                                                    </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="answer" class="col-sm-1 control-label">Answer<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-10">
                                                    <textarea class="form-control" id="answer" name="answer" rows="10" placeholder="Answer">{{$faq->faq_answer}}</textarea>
