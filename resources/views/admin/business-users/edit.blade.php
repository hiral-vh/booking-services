...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-owners.update', $user->id) }}"
                                            id="userCreateForm" class="form-horizontal" enctype='multipart/form-data'>
                                            @csrf
                                            @method('put')
                                            <input type="hidden" name="businessUserId" id="businessUserId" value="{{$user->id}}">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <span class="error"
                                                        id="firstNameSpan">{{ $errors->admin->first('firstName') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <span class="error"
                                                        id="lastNameSpan">{{ $errors->admin->first('lastName') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <span class="error"
                                                        id="businessNameSpan">{{ $errors->admin->first('businessName') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="businessEmail" class="col-sm-3 control-label">Business
                                                    Email<span class="error">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="businessEmail"
                                                        name="businessEmail" placeholder="Business Email"
                                                        value="{{ $user->business->email }}">
                                                    <span class="error"
                                                        id="businessEmailSpan">{{ $errors->admin->first('businessEmail') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="businessAbout" class="col-sm-3 control-label">Business
                                                    About<span class="error">*</span></label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" id="businessAbout" name="businessAbout"
                                                        placeholder="Business About" cols="30"
                                                        rows="5">{{ $user->business->about }}</textarea>
                                                    <span class="error"
                                                        id="businessAboutSpan">{{ $errors->admin->first('businessAbout') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="service" name="service">
                                                        ...
                                                        @foreach ($service as $value)
                                                            <option value="{{ $value->id }}" @if ($value->id == $user->business->service_id) selected @endif>
                                                                {{ $value->name }}</option>
                                                        @endforeach

                                                    </select>
                                                    <span class="error"
                                                        id="serviceSpan">{{ $errors->admin->first('service') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/8.4.6/css/intlTelInput.css">
