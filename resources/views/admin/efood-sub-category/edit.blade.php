                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form method="POST" action="{{ route('food-sub-category.update',$edit->id) }}" id="adminCreateForm" class="form-horizontal" enctype='multipart/form-data'>
                                        @csrf
                                        @method('put')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="category_id" name="category_id">
                                                    ...
                                                    <option value="{{$value->id}}"<?php if ($edit->category_id == $value->id) {
                                                                                        echo "selected";
                                                                                    } ?>>{{$value->name}}</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Sub Category" value="{{$edit->name}}">
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="file" class="form-control" id="subCategoryImage" name="image" value="{{$edit->image}}" oninput="pic.src=window.URL.createObjectURL(this.files[0])">
                                                <span class="error" id="imageSpan">{{$errors->admin->first('image')}}</span>
                                            </div>
                                            @if (!empty($edit->image))
                                            <div class="col-sm-4">
                                                <img src="{{ asset($edit->image) }}" alt="Image" class="logo-lg" style="height:100px;width:100px" id="pic">
                                            </div>
                                            @else
                                            <div class="col-sm-4">
...
<script>
    $("#adminCreateForm").submit(function(e) {
        ...
        if ($("#category_id").val() == "") {
            $("#categorySpan").html("Please enter Category");
            temp++;
        } else {
            $("#categorySpan").html("");
        }
