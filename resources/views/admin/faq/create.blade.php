                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('faq.store') }}" id="faqCreateForm"
                                            ...
                                            <div class="form-group row">
                                                <label for="question" class="col-sm-1 control-label space-for-label">Question<span
                                                    ...
                                                    <div class="col-sm-11">
                                                    <textarea class="form-control" id="question" name="question" rows="3" placeholder="Question">{{old('question')}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <label for="answer" class="col-sm-1 control-label space-for-label">Answer<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-11">
                                                    <textarea class="form-control" id="answer" name="answer" rows="10" placeholder="Answer">{{old('answer')}}</textarea>
