                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-1">
                                    <a href="{{route('business-service-create',$business->id)}}"><button type="button" class="btn waves-effect btn-secondary" title="Add"><i class="ion ion-md-add"></i></button></a>
                                </div>
                                <div class="col-12">
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="business_service_{{$value->id}}">
                                                    ...
                                                    <td width="100px">
                                                        <a href="{{route('business-service-edit',$value->id)}}" class="btn create-icon"><i
                                                        ...
                                                        <form id="Deletesubmit_{{ $value->id }}"
                                                            action="{{route('business-service-delete',[$value->id,'business_id'=>$business->id])}}"
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="4" align="center">No Business Service Available</th>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                          </table>
...
<script>
    $(document).on("change", ".toggle", function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{route('businessServiceStatus')}}",
            data: {
                'id': id,
                '_token':token
            },
