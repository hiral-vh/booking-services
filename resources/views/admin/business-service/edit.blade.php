...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('business-service-index',$businessService['business']->id) }}"><button type="button"
                                                class="btn waves-effect btn-secondary"><i
                                                    class="ion ion-md-arrow-back" title="back"></i></button></a>
                                    </div>
                                    <div class="col-12">
                                        <form method="POST" action="{{route('business-service-update',$businessService->id)}}" id="businessServiceEditForm"
    ...
    <script>
        $("#businessServiceEditForm").submit(function(e) {
            ...
            if($("#timing").val() == "")
            {
                $("#timingSpan").html("The Timing Field Is Required");
                temp++;
            }
            else
            {
