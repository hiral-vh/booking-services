                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('business-admin.create') }}"><button type="button"
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse ($business as $value)
                                                        <tr id="business_{{ $value->id }}">
                                                            ...
                                                            <td width="170px">
                                                                <a href="{{ route('business-admin.edit', $value->id) }}"
                                                                ...
                                                                <form id="Deletesubmit_{{ $value->id }}"
                                                                    action="{{ route('business-admin.destroy', $value->id) }}"
                                                                    method="POST" class="d-none">
                                                                    @csrf
                                                                    @method('delete')
                                                                </form>

                                                                <a href="{{ route('business-about-us.index', ['business_id' => $value->id]) }}"
                                                                    class="btn create-icon"
                                                                    title="About {{ $value->name }}"><i
                                                                        class="fa fa-fw fa-info-circle"></i></a>

                                                                <a href="{{ route('business-service-index', $value->id) }}"
                                                                    class="btn create-icon"
                                                                    title="{{ $value->name }} Services"><i
                                                                        class="fa fa-wrench"></i></a>

                                                                <a href="{{ route('business-team-member-index', $value->id) }}"
                                                                    class="btn create-icon" title="Assign Team Members"><i
                                                                        class="fa fa-fw fa-users"></i></a>

                                                                <a href="{{ route('business-offer-index', $value->id) }}"
