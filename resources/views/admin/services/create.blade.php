                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form method="POST" action="{{ route('services.store') }}" id="adminCreateForm" class="form-horizontal" enctype='multipart/form-data'>
                                        @csrf
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-1 control-label space-for-label">Service<span class="error">*</span></label>
                                            <div class="col-sm-11">
                                        ...
                                        <div class="form-group row">
                                            <label for="image" class="col-sm-1 control-label space-for-label">Image<span class="error">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="file" class="form-control" id="serviceImage" name="image" oninput="pic.src=window.URL.createObjectURL(this.files[0])" accept="image/png, image/jpg, image/jpeg, image/svg">
...
<script>
    $("#adminCreateForm").submit(function(e) {
        ...
        if ($("#serviceImage").val() == "") {
            $("#imageSpan").html("Please choose Image");
            temp++;
        } else {
