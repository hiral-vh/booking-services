...
<style>
    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">About {{ $business->name }}</h4>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-about-us.update',$businessAboutUs->id) }}" id="businessAboutUsEditForm"
                                            ...
                                            <div class="form-group row">
                                                <label for="description" class="col-sm-3 control-label">Location<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-9">
                                                    <textarea class="form-control" id="location" name="location" row="5">{{$businessAboutUs->location}}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="hidden" id="country_code" value="{{$businessAboutUs->country_code}}" name="country_code" />
                                                <div class="col-sm-9">
                                                    <input type="text" name="mobile" autocomplete="off" value="{{$businessAboutUs->country_code}}" class="form-control" id="phone" onkeypress="return isNumber(event)" placeholder="Mobile"> <span style="color: red;" id="Phoneerror">{{$errors->admin->first('mobile')}}</span>
                                            ...
                                            <div class="form-group row">
                                                <label for="description" class="col-sm-3 control-label">Description<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-9">
                                                    <textarea class="form-control" id="description" name="description" row="5">{{$businessAboutUs->description}}</textarea>
    ...
    setTimeout(function() {
        $("#phone").val('<?= $businessAboutUs->contact ?>');
    }, 1000);
    </script>
@endsection
