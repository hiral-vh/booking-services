                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('food-type.index') }}"><button type="button"
                                                class="btn waves-effect btn-secondary"><i
                                                    class="ion ion-md-arrow-back"></i></button></a>
                                    </div>
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('food-type.update',$foodType->id) }}" id="foodTypeForm"
                                            class="form-horizontal" enctype='multipart/form-data'>
                                            @csrf
                                            @method('put')
                                            <div class="form-group row">
                                                <label for="name" class="col-sm-1 control-label space-for-label">Category<span
                                                        class="error">*</span></label>
                                                <div class="col-sm-11">
                                                    <input type="text" class="form-control" id="name" name="name"
                                                        placeholder="Category" value="{{ $foodType->food_category_name }}">
                                                    <span class="error"
                                            ...
                                            <div class="form-group row">
                                                <label for="image" class="col-sm-1 control-label space-for-label">Image<span
                                                        class="error">*</span></label>
                                                <div class="col-sm-5">
                                                    <input type="file" class="form-control" id="foodTypeImage" name="image"
                                                ...
                                                <div class="col-sm-4">
                                                    <img src="{{ asset($foodType->food_category_image) }}" alt="Image"
