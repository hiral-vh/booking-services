...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('business-user.index') }}"><button type="button"
                                                class="btn waves-effect btn-secondary"><i
                                                    class="ion ion-md-arrow-back" title="back"></i></button></a>
                                    </div>
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-user.store') }}" id="businessCreateForm"
    ...
    <script>
        $("#businessCreateForm").submit(function(e) {
            var temp = 0;
            if ($("#name").val() == "") {
