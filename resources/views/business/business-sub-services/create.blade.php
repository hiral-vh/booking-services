                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <a href="{{ route('business-owner-subservices.index') }}"><button type="button" class="btn waves-effect btn-secondary"><i class="ion ion-md-arrow-back"></i></button></a>
                                </div>
                                <div class="col-12">
                                    <form method="POST" action="{{ route('business-owner-subservices.store') }}" id="adminCreateForm" class="form-horizontal" enctype='multipart/form-data'>
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span class="error" id="serviceSpan">{{$errors->admin->first('business_service_id')}}</span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 control-label">Time(Duration)<span class="error">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="time" name="time" placeholder="Time" maxlength="3">
                                        ...
                                        <div class="form-group row">
                                            <label for="image" class="col-sm-3 control-label">Image<span class="error">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="file" class="form-control" id="image" name="image" oninput="pic.src=window.URL.createObjectURL(this.files[0])" accept="image/png, image/jpg, image/jpeg, image/svg, image/bmp">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                <label for="team_member" class="col-sm-3 control-label pl-0">Team Member<span class="error">*</span></label>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" class="form-control" id="teamPrice" name="teamPrice" placeholder="Price">
                                                <span class="error" id="teampriceSpan">{{$errors->admin->first('teamPrice')}}</span>

                                            </div>
                                            <div class="col-sm-1">
                                                <div class="pt-30">
                                                    <button type="button" class="btn btn-primary waves-effect waves-light add_price">Add</button>
                                                </div>

                                            </div>
                                            <span style="color:red;padding-left:10px;" id="same_team_error"></span>
                                        </div>
...
<script>
    ...
    $('.add_price').click(function() {
        ...
        if ($("#team_member").val() == "") {
            $("#teamMemberSpan").html("Please select Team Member");
            temp1++;
        } else {
            $("#teamMemberSpan").html("");
        }
        ...
        if ($("#teamPrice").val() == "") {
            $("#teampriceSpan").html("Please enter Price");
            temp1++;
        } else {
            $("#teampriceSpan").html("");
        }
        ...
        if (temp1 == 0) {
            ...
            if (allattri.indexOf(teamMember_val) == -1) {
                ...
                var new_row = "<tr id='tabrow" + i + "'><td>" + teamMember + "</td><td>£"+ price +"</td><td>" + del + "</td></tr>";
                var hidden_attribute = "<div id='team_hidden_value" + i + "'><input type='hidden' name='team_member_id[]' value=" + teamMember_val + "><input type='hidden' name='team_price[]' value=" + price + "></div>";
    ...
    $("#adminCreateForm").submit(function(e) {
        ...
        if ($("#image").val() == "") {
            ...
            var imageRegex = new RegExp("(.*?)\.(jpg|png|jpeg|JPG|PNG|JPEG|svg|SVG|bmp|BMP)$");
