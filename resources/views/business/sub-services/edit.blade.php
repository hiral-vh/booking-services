                                ...
                                <div class="col-12">
                                    <form method="POST" action="{{ route('sub-services.update',$subService->id) }}" id="adminEditForm" class="form-horizontal" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="service_id" name="service_id">
                                                    ...
                                                    <option value="{{$service->id}}" <?php if ($subService->service_id == $service->id) {
                                                                                        echo "selected";
                                                                                    } ?>>{{$service->name}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name" name="name" value="{{$subService->name}}" placeholder="Sub Service">
...
<script>
    $("#adminEditForm").submit(function(e) {
        ...
        if ($("#service_id").val() == "") {
            $("#serviceSpan").html("Please select Business Service");
            temp++;
        } else {
            $("#serviceSpan").html("");
        }
