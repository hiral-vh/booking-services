                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-team-members.store') }}"
                                            id="businessTeamMemberCreateForm" class="form-horizontal"
                                            enctype='multipart/form-data'>
                                            @csrf
                                            <input type="hidden" value="{{ $business->id }}" id="business_id"
                                                name="business_id">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="team_member"
                                                        name="team_member" placeholder="Team Member" maxlength="30" value="{{old('team_member')}}">
                                                    <span class="error"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="email" name="email"
                                                        placeholder="Email" value="{{old('email')}}" maxlength="100">
                                                    <span class="error"
        ...
        $("#businessTeamMemberCreateForm").submit(function(e) {
            ...
            if ($("#phone_no").val() == "") {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    async: false,
                    url:"{{ route('team-member-check-mobile') }}",
                    data: {
                        'mobile': mobile,
                    },
                    success: function(data) {
                        if(data == 1)
                        {
                            $('#phoneNoSpan').html('Phone No is already exists');
                            temp++;
                        }else{
                            $('#phoneNoSpan').html('');
                        }
            ...
            }else if($("#email").val().length > 100)
            {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    async: false,
                    url:"{{ route('team-member-check-email') }}",
                    data: {
                        'email': email,
                    },
                    success: function(data) {
