...
<style>
    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">About {{ ucfirst($business->business!=null?$business->business->name:'N/A') }}</h4>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-user-about-us.store') }}" id="businessAboutUsCreateForm"
                                            class="form-horizontal" enctype='multipart/form-data'>
                                            @csrf
                                            <input type="hidden" value="{{ ($business->business!=null?$business->business->id:'') }}" id="business_id" name="business_id">
                                            ...
                                            <div class="form-group row">
                                                <label for="description" class="col-sm-3 control-label">Location<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-9">
                                                    <textarea class="form-control" id="location" name="location" row="5" placeholder="Location"></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="mobile" autocomplete="off" value="{{ old('mobile')}}" class="form-control" id="phone" onkeypress="return isNumber(event)" placeholder="Contact"> <span style="color: red;" id="Phoneerror">{{$errors->admin->first('mobile')}}</span>
                                            ...
                                            <div class="form-group row">
                                                <label for="description" class="col-sm-3 control-label">Description<span
                                                    class="error">*</span></label>
                                                    <div class="col-sm-9">
                                                    <textarea class="form-control" id="description" name="description" row="5" placeholder="Description"></textarea>
    ...
    <script>
        $("#businessAboutUsCreateForm").submit(function(e) {
            ...
            if($("#location").val() == "")
            {
                $("#locationSpan").html("Please enter Location");
                temp++;
            }
            else
            {
            ...
            if ($("#phone").val() == "") {
                    temp++;
                    $('#Phoneerror').html("Please enter Contact");
                    $('#phone').focus();
            }
            else
            {
    ...
    <script>
        ...
        var telInput = $("#phone"),
            errorMsg = $("#mobileerror").html('Invalid Contact'),
            validMsg = $("#valid-msg");
        ...
        telInput.blur(function() {
            ...
            if ($.trim(telInput.val())) {
                if (telInput.intlTelInput("isValidNumber")) {
                    ...
                    $("#mobileerror").html('Invalid Contact');
                    $("#Phoneerror").html('');
                }
            }
        });
