...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <a href="{{ route('business-user-team-member.index') }}"><button type="button"
                                                class="btn waves-effect btn-secondary"><i
                                                    class="ion ion-md-arrow-back"></i></button></a>
                                    </div>
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('business-user-team-member.update',$teamMember) }}" id="teamMemberEditForm"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="name" name="name"
                                                        placeholder="Name" value="{{$teamMember->name}}">
                                            ...
                                            <div class="form-group row">
                                                <label for="charge" class="col-sm-3 control-label">Charge<span
                                                        class="error">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="charge" name="charge" value="{{$teamMember->charge}}"
    ...
    <script>
        $("#teamMemberEditForm").submit(function(e) {
            var temp = 0;
