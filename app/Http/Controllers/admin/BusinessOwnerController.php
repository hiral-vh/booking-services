...
class BusinessOwnerController extends Controller
{
    ...
    {
        $this->data['services'] = $services = $request->services;
        $this->data['name'] = $name = $request->name;
        $this->data['email'] = $email = $request->email;
        $this->data['mobile'] = $mobile = $request->mobile;
        $this->data['list'] = Business::getAllOwners($services, $name, $email, $mobile);
        $this->data['module'] = 'Business Owners List';
        return view('admin.business-owner.index', $this->data);
    }
