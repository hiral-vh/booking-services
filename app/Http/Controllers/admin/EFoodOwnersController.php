...
class EFoodOwnersController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $this->data['list'] = FoodOwner::getAllOwners($restaurantName, $ownerName, $email, $mobile);
        $this->data['module'] = 'Food Owners List';
        return view('admin.efood-owners.index', $this->data);
    }
